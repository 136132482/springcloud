...
public class Constants {
     ...
     * 缓存命名空间
     */
    public static final String CACHE_NAMESPACE = "odfly";
     ...
     * CODE 209 使用非法字符
     */
    public static Map<String, String> SYSTEM_INVALID_SYMBOL_ERROR;

    static {
        if (SYSTEM_INVALID_SYMBOL_ERROR == null) {
            SYSTEM_INVALID_SYMBOL_ERROR = new HashMap<String, String>(3) {
                {
                    put(CODE, "209");
                    put(SYS_MSG, "请勿使用非法字符");
                    put(MSG, "请勿使用非法字符");
                }
            };
        }
     ...
     * CODE 210 密码不合法
     */
    public static Map<String, String> SYSTEM_INVALID_PASSWORD_ERROR;

    static {
        if (SYSTEM_INVALID_PASSWORD_ERROR == null) {
            SYSTEM_INVALID_PASSWORD_ERROR = new HashMap<String, String>(3) {
                {
                    put(CODE, "210");
                    put(SYS_MSG, "密码至少6位字母加数字");
                    put(MSG, "密码至少6位字母加数字");
                }
            };
        }
     ...
     * CODE 204 SYS_MSG 系统保存数据时发生异常 MSG 网络开了一会小差，信息保存失败
     */
    public static Map<String, String> SYSTEM_DATA_FORMAT_ERROR;

    static {
        if (SYSTEM_DATA_FORMAT_ERROR == null) {
        	SYSTEM_DATA_FORMAT_ERROR = new HashMap<String, String>(3) {
                {
                    put(CODE, "204");
                    put(SYS_MSG, "校验请求参数发生错误");
                    put(MSG, "请求参数错误，请重新输入！");
                }
            };
        }
    }
