...
//          String type = origDescriptors[i].getPropertyType().toString();
     ...
     */
    public static void copyBean2Bean(Object databean, Object tobean) {
        try {
            convert(tobean, databean);
        } catch (Exception e) {
        }
    ...
    public static void copyMap2Bean(Map properties, Object bean) throws
        ...
        while (names.hasNext()) {
            String name = (String) names.next();
            // Identify the property name andvalue(s) to be assigned
            if (name == null) {
                continue;
            }
...
//              }
     ...
     * @throws InvocationTargetException
     */
    public static void copyMap2Bean(Map properties, Object bean, String defaultValue) throws
            IllegalAccessException, InvocationTargetException {
        // Do nothing unless both arguments have been specified
        if ((bean == null) || (properties == null)) {
            return;
     ...
     * @param textMap 文本
     */
    public static void beanToMap(Object bean, Map<String, File> fileMap, Map<String, String> textMap) {
        try {
            ...
            for (int i = 0; i < propertyDescriptors.length; i++) {
                ...
                if (simpleProperty instanceof File) {
                    fileMap.put(name, (File) simpleProperty);
                } else if (simpleProperty instanceof String) {
                    textMap.put(name, (String) simpleProperty);
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
